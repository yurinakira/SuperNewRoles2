            ...
            private void GetPlayerCounts()
            {
                ...
                for (int i = 0; i < GameData.Instance.PlayerCount; i++)
                {
                    ...
                    if (!playerInfo.Disconnected && playerInfo.Object.IsPlayer())
                    {
                        ...
                        {
                            numTotalAlive++;
                            if (playerInfo.Object.isRole(RoleId.Jackal) || playerInfo.Object.isRole(CustomRPC.RoleId.Sidekick) || playerInfo.Object.isRole(CustomRPC.RoleId.TeleportingJackal) || playerInfo.Object.isRole(CustomRPC.RoleId.JackalSeer) || playerInfo.Object.isRole(CustomRPC.RoleId.SidekickSeer)|| RoleClass.SchrodingerCat.IsJackal(playerInfo.Object))
                            {
                                numTotalJackalTeam++;
                            }
