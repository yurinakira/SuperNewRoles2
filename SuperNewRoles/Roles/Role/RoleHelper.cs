    ...
    public static class RoleHelpers
    {
        ...
        public static void SetRole(this PlayerControl player, RoleId role)
        {
            switch (role)
            {
                ...
                case RoleId.ToiletFan:
                    ...
                    break;
                case (RoleId.Medic):
                    RoleClass.Medic.MedicPlayer.Add(player);
                    break;
                //ロールアド
                default:
        ...
        public static void ClearRole(this PlayerControl player)
        {
            ...
            switch (player.GetRole())
            {
                ...
                case RoleId.ToiletFan:
                    ...
                    break;
                    case (RoleId.Medic):
                    RoleClass.Medic.MedicPlayer.RemoveAll(ClearRemove);
                    break;
                //ロールリモベ
            }
            ChacheManager.ResetMyRoleChache();
        ...
        public static RoleId GetRole(this PlayerControl player, bool IsChache = true)
        {
            ...
            try
            {
                ...
                else if (RoleClass.Medic.MedicPlayer.IsCheckListPlayerControl(player)) return RoleId.Medic;
                //ロールチェック
            }
            catch (Exception e)
            {
