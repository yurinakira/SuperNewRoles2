...
namespace SuperNewRoles.Intro
{
    public class IntroDate
    {
        ...
        public static IntroDate SchrodingerCatIntro = new IntroDate("SchrodingerCat", RoleClass.SchrodingerCat.color, 1, CustomRPC.RoleId.SchrodingerCat);
        //イントロオブジェ
    }
}
