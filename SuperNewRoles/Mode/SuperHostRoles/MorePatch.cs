...
namespace SuperNewRoles.Mode.SuperHostRoles
{
    class MorePatch
    {
                ...
                byte amount)
        {
            ...
            {
                if ((player.isRole(RoleId.Jackal) && !RoleClass.Jackal.IsUseSabo) || (player.isRole(RoleId.JackalSeer) && !RoleClass.JackalSeer.IsUseSabo) || player.isRole(RoleId.Demon) || player.isRole(RoleId.Arsonist) || player.isRole(RoleId.RemoteSheriff) || player.isRole(RoleId.Sheriff) || player.isRole(RoleId.truelover) || player.isRole(RoleId.FalseCharges) || player.isRole(RoleId.MadMaker)) return false;
