...
namespace SuperNewRoles.Buttons
{
    class ButtonTime
    {
        ...
        public static void SheriffKillButton()
        {
            ...
            var TimeSpanDate = new TimeSpan(0, 0, 0, (PlayerControl.LocalPlayer.isRole(CustomRPC.RoleId.Sheriff) || RoleClass.SchrodingerCat.IsSheriff()) ? (int)Roles.RoleClass.Sheriff.CoolTime : (int)Roles.RoleClass.RemoteSheriff.CoolTime);
