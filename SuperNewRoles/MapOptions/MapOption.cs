...
namespace SuperNewRoles.MapOptions
{
    ...
    public class MapOption
    {
        ...
        public static CustomOption.CustomOption AirshipRemodelingSetting;
        ...
        public static void LoadOption()
        {
            ...
            */
            ...
            AirshipRemodelingSetting = MapRemodelingOption = CustomOption.CustomOption.Create(604, false, CustomOptionType.Generic, "AirshipRemodelingOptionSetting", false, MapRemodelingOption);
            AirshipAdditionalSpawn = CustomOption.CustomOption.Create(9917, false, CustomOptionType.Generic, "airshipAdditionalSpawn", false, AirshipRemodelingSetting);
            AirshipSynchronizedSpawning = CustomOption.CustomOption.Create(9918, false, CustomOptionType.Generic, "airshipSynchronizedSpawning", false, AirshipRemodelingSetting);
            AirshipInitialDoorCooldown = CustomOption.CustomOption.Create(9923, false, CustomOptionType.Generic, "airshipInitialDoorCooldown", 0f, 0f, 60f, 1f, AirshipRemodelingSetting);
            AirshipInitialSabotageCooldown = CustomOption.CustomOption.Create(9924, false, CustomOptionType.Generic, "airshipInitialSabotageCooldown", 15f, 0f, 60f, 1f, AirshipRemodelingSetting);
