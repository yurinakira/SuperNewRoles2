    ...
    public class SpawnInMinigamePatch
    {
        ...
        public static void resetSpawnCandidates()
        {
            ...
            if (MapOption.AirshipAdditionalSpawn.getBool())
            {
                ...
                SpawnCandidates.Add(new SpawnCandidate(StringNames.Cockpit, new Vector2(-22.0f, -1.2f), "SuperNewRoles.Resources.Locations.CockpitButton.png", "rollover_brig"));
                SpawnCandidates.Add(new SpawnCandidate(StringNames.Electrical, new Vector2(16.4f, -8.5f), "SuperNewRoles.Resources.Locations.ElectricalButton.png", "rollover_brig"));
                SpawnCandidates.Add(new SpawnCandidate(StringNames.Lounge, new Vector2(30.9f, 7.5f), "SuperNewRoles.Resources.Locations.LoungeButton.png", "rollover_brig"));
                SpawnCandidates.Add(new SpawnCandidate(StringNames.Medical, new Vector2(25.5f, -5.0f), "SuperNewRoles.Resources.Locations.MedicalButton.png", "rollover_brig"));
                SpawnCandidates.Add(new SpawnCandidate(StringNames.Security, new Vector2(10.3f, -16.2f), "SuperNewRoles.Resources.Locations.SecurityButton.png", "rollover_brig"));
                SpawnCandidates.Add(new SpawnCandidate(StringNames.ViewingDeck, new Vector2(-14.1f, -16.2f), "SuperNewRoles.Resources.Locations.ViewingButton.png", "rollover_brig"));
                SpawnCandidates.Add(new SpawnCandidate(StringNames.Armory, new Vector2(-10.7f, -6.3f), "SuperNewRoles.Resources.Locations.ArmoryButton.png", "rollover_brig"));
                SpawnCandidates.Add(new SpawnCandidate(StringNames.Comms, new Vector2(-11.8f, 3.2f), "SuperNewRoles.Resources.Locations.CommunicationsButton.png", "rollover_brig"));
                SpawnCandidates.Add(new SpawnCandidate(StringNames.Showers, new Vector2(20.8f, 2.8f), "SuperNewRoles.Resources.Locations.ShowersButton.png", "rollover_brig"));
                SpawnCandidates.Add(new SpawnCandidate(StringNames.GapRoom, new Vector2(13.8f, 6.4f), "SuperNewRoles.Resources.Locations.GapButton.png", "rollover_brig"));
...
/*
        private static void resetButtons()
        {
            ...
            if (CustomOptionHolder.airshipSetOriginalCooldown.getBool())
            {
                ...
                foreach (var b in Buttons.CustomButton.buttons)
                {
                    b.Timer = b.MaxTimer;
                }
            }
        ...
        {
            MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.CustomRPC.Synchronize, Hazel.SendOption.Reliable, -1);
            writer.Write(playerId);
            writer.Write((int)tag);
            AmongUsClient.Instance.FinishRpcImmediately(writer);
            CustomRPC.RPCProcedure.synchronize(playerId, (int)tag);
        }
