...
#nullable enable
        ...
        public Texture2D GetTexture()
        {
            ...
            Texture = ModHelpers.loadTextureFromResources(TextureAddress);
            ReloadSprites();
            return Texture;
        }
        ...
        {
            if (!Texture) Texture = ModHelpers.loadTextureFromResources(TextureAddress);
            ReloadSprites();
        }
        ...
        private void ReloadSprites()
        {
            ...
            {
                Sprites[i] = ModHelpers.loadSpriteFromResources(Texture, 100f, new Rect((float)(i * 200), 0f, 200f, -200f), new Vector2(0.5f, 1f));
            }
        }
